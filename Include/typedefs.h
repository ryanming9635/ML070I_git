...
#define _CHARGE000mA    0xFF//0xE0  //minimum

#define _CHARGE060mA    0xFF//0xE0  //60mA
#else
...
#if ( _BATTERY_CHARGE_STOP==ON)
#define _CHARGESTOP    0xFF///maximum
#endif
#else
#define _CHARGE100mA    0xF4
...
typedef enum
{
 ...
 //   _USER_TIMER_EVENT_KEY_REPEAT_ENABLE = _USER_TIMER_EVENT_START,   
   // _USER_TIMER_EVENT_KEY_SCAN_READY,
    ...
    _USER_TIMER_EVENT_REPLY_ENCODER_COUNT,    
...
_SYSTEM_TIMER_EVENT_CHECK_BATTERY_STOP_STATE,
//
...
_SYSTEM_TIMER_EVENT_BATT_LOW_RED_BLINK,	   
	...
	_SYSTEM_TIMER_EVENT_BATTERY_VOLTAGE_READY_CHECK,
	_SYSTEM_TIMER_EVENT_BATTERY_VOLTAGE_DISABLE_CHECK,
