...
long EncorderCount=0;
long EncorderCountINT=0;
BYTE  bytPNFlagEncoder=0;
	
WORD bytEncorderCountTemp=0;
BYTE   bytFastEncorderCountTemp=0;
...
{
	EX0 = 0;
	if(bytPNFlagEncoder==0)
	EncorderCountINT++;
	else
	EncorderCountINT--;

	if(bytFastEncorderCountTemp>=100)			
		{
		ulongRotateNumberTELI++;
		bytFastEncorderCountTemp=0;
		}
	else
		bytFastEncorderCountTemp++;
